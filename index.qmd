...
parallel::parLapply(X = tasks, fun = Sys.sleep)
```
. . .

<span style="color:#ff0000">8 seconds!</span>

. . .

```r
parallel::parLapplyLB(X = tasks, fun = Sys.sleep)
```
. . .

<span style="color:#ff0000">5 seconds!</span>
...
```r
tasks <- c(1, 1, 4, 4, 1, 1, 1, 1)
mirai::mirai_map(tasks, Sys.sleep)[]
```

. . .

<span style="color:#00ff66">4 seconds</span>
